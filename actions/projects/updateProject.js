export default {
  async updateProject ({ commit, dispatch }, data) {
    let response
    try {
      response = await this.$axios.$post('https://api.galexia.agency/projects',
        {
          ...data
        },
        {
